...
Destination table: `tvlk-data-user-dev.xs_playground.XS_T1_L4_transaction_cross_products_per_user`
Output Field: 
    * event_month 
...
-- CREATE OR REPLACE TABLE `tvlk-data-user-dev.xs_playground.XS_T1_L4_transaction_cross_products_per_user`
...
FROM
  `tvlk-data-user-dev.xs_playground.XS_T1_L3_transaction_cross_products_per_user`
WHERE
