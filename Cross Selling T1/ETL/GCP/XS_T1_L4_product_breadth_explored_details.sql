...
Destination table: `tvlk-data-user-dev.xs_playground.XS_T1_L4_product_breadth_explored_details
Output Field: 
    * dt,
    * period,
    * metric,
...
-- CREATE OR REPLACE TABLE `tvlk-data-user-dev.xs_playground.XS_T1_L4_product_breadth_explored_details`
-- PARTITION BY (dt) AS

DELETE FROM 
  `tvlk-data-user-dev.xs_playground.XS_T1_L4_product_breadth_explored_details`
WHERE 
  ((EXTRACT(day
      FROM
        CURRENT_DATE()) = 1
...
INSERT INTO `tvlk-data-user-dev.xs_playground.XS_T1_L4_product_breadth_explored_details`
...
WITH
  ...
  SELECT
    ...
    main_product,
  IF
    (REGEXP_CONTAINS(product.secondary_product, r'_'),
      PROPER(REPLACE(product.secondary_product, '_', ' ')),
